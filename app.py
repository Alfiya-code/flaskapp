...
conn = pymysql.connect(host='ba9meuiqlprvfo8hjftf-mysql.services.clever-cloud.com', user='u0qgzhbj9orltmqg', password = "edG28gwwDokXveTcW71w", db='ba9meuiqlprvfo8hjftf')
